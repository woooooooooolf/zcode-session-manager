...
const I18N = {
  zh: {
    ...
    "about.title": "关于",
    "about.version": "版本",
    "about.changelogTitle": "版本说明",
    "about.changelog100": "1.0.0（开发中）：会话扫描与详情、单删/多选删除、删除前备份、删除后完整性校验与自动恢复、格式兼容性检查、受限模式（ZCode 运行时可删除归档且闲置超阈值的会话，阈值可设）、中英双语、三种主题。",
    "about.complianceTitle": "开源合规",
    "about.compliance": "本工具基于开源组件构建：Tauri（MIT / Apache-2.0）、rusqlite / SQLite（MIT；SQLite 本体属公有领域）、serde（MIT / Apache-2.0）、chrono（MIT / Apache-2.0）、sysinfo（MIT）等。完整许可证文本随源码一同发布。",
    "about.author": "作者",
    "about.authorValue": "woooooooooolf（linyar.windforest@gmail.com）",
    "about.github": "GitHub 仓库：（发布后在此填入链接）",
  ...
  en: {
    ...
    "about.changelogTitle": "Release notes",
    "about.changelog100": "1.0.0 (in development): session scanning and detail view, single/bulk delete, pre-delete backup, post-delete integrity check with auto-restore, format compatibility checks, limited mode (delete archived + idle sessions while ZCode runs, adjustable threshold), English/Chinese UI, three themes.",
    "about.complianceTitle": "Open-source compliance",
    "about.compliance": "Built on open-source components: Tauri (MIT / Apache-2.0), rusqlite / SQLite (MIT; SQLite itself is public domain), serde (MIT / Apache-2.0), chrono (MIT / Apache-2.0), sysinfo (MIT) and others. Full license texts ship with the source.",
    "about.author": "Author",
    "about.authorValue": "woooooooooolf (linyar.windforest@gmail.com)",
    "about.github": "GitHub repository: (link will be added upon release)",
